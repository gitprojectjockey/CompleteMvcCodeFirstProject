namespace ContosoWebUI.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ContosoWebUI.DAL.SchoolContext>
    {
        ...
        protected override void Seed(DAL.SchoolContext context)
        {
            ...
            var officeAssignments = new List<OfficeAssignment>
            {
                new OfficeAssignment {
                    InstructorID = instructors.Single( i => i.LastName == "Fakhouri").ID,
                    Location = "Smith Allen Hall Room 17" },
                new OfficeAssignment {
                    InstructorID = instructors.Single( i => i.LastName == "Harui").ID,
                    Location = "Gowan Hall Room 27" },
                new OfficeAssignment {
                    InstructorID = instructors.Single( i => i.LastName == "Kapoor").ID,
                    Location = "Thompson Hall Room 304" },
            };
